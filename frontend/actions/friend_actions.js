...
export const showFriendships = friendships => (
    dispatch => (
        FriendAPIUtil.showFriendships(friendships)
...
export const createFriendship = friendship => (
    dispatch => (
        FriendAPIUtil.createFriendship(friendship)
...
export const deleteFriendship = friendshipId => (
    dispatch => (
        FriendAPIUtil.deleteFriendship(friendshipId)
